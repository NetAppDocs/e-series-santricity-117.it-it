...
Al termine, fare clic su *Aggiungi*, quindi su *Chiudi*.
...
Dopo aver fatto clic su *Aggiungi*, le destinazioni trap e i nomi associati vengono visualizzati nella scheda *SNMP* della pagina *Avvisi*.
